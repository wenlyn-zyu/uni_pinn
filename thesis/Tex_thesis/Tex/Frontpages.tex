...
Experiments are conducted on two types of data: (1) synthetic data generated from analytical/semi-analytical reference solutions across 72 parameter variants (6 BSM + 12 CEV + 54 Heston), evaluated at 50 uniformly sampled points $S\in[50,250]$; (2) real market data from CBOE SPY (S\&P 500 ETF) option chain (May 11, 2026, SPY price \$739.75), comprising 2,824 contracts across 23 expiries covering $T\in[0.06,2.59]$ years. Experimental results show that the unified PINN achieves high accuracy in the ATM region across all three models, and outperforms independently trained PINN baselines on BSM and CEV. The LLM routing layer achieves accurate model selection and parameter extraction on all test cases, enabling real-time pricing.
